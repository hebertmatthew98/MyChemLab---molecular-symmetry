...
lineartest::initpatch(int numAtoms, double inputCoord[][3])
{
    solveRelativity Solve;

    initval(numAtoms, inputCoord, Solve);
...
lineartest::initval(int numAtoms, double inputCoord[][3], solveRelativity &Solve)
{
    numAtoms = numAtoms;
    Solve.plane3d = 0;
    Solve.test = 0;
    ...
    for(int an = 0; an < numAtoms; an++)
    {
        for(int axis = 0; axis < 3; axis++)
        {
            inputCoord[an][axis] = inputCoord[an][axis];
        }
    }
